      ...
      <div className="w-full h-auto">
        <div className="w-full h-52 lg:h-52 bg-background flex flex-col items-center justify-center">
          ...
          <text className="block text-white text-center mt-5 capitalize text-lg">
            home / <text className="text-primary_pink">service</text>
          </text>
        </div>
        <div className="px-5 lg:mx-0 pt-8 lg:py-16 lg:flex justify-center bg-background">
          <div className="lg:w-[70rem] lg:indent-10 indent-5 pb-5 lg:pb-0">
            <text className="block leading-relaxed text-lg text-center text-text_color">
              I offer an extensive array of services, distinguished by their
              top-notch performance, coupled with an enduring commitment to
              maintaining the integrity of your critical products throughout
              their lifecycle. I invite you to explore the comprehensive list of
              services below to discover how I can cater to your specific needs
              and objectives.
            </text>
          </div>
        </div>
        <div className="grid sm:flex justify-center pt-10">
            ...
            {service.map((item, index) => {
              return (
                <div className="cursor-pointer w-64 lg:w-96 xl:w-[26rem] h-74 lg:h-[17.2rem] rounded-lg bg-gradient-to-r xl:bg-black  from-primary_gold xl:from-background_second xl:to-background_second to-primary_pink mb-5 p-5 sm:mx-3 lg:mx-5 lg:my-5 xl:hover:from-primary_gold xl:hover:to-primary_pink transition ease-in-out delay-150 xl:hover:-translate-y-1 xl:hover:scale-105 duration-300">
                  ...
                  <text className="text-white/70 capitalize font-light">
                    {item.dicription}
                  </text>
                </div>
              );
